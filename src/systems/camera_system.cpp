...
bool CameraSystem::update(std::unordered_map<unsigned int, TransformComponent>& transformComponent, unsigned int cameraID, CameraComponent& cameraComponent, float dt)
{
