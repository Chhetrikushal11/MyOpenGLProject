...
void RenderSystem::update(std::unordered_map<unsigned int, TransformComponent>& transformComponent, std::unordered_map<unsigned int, RenderComponent>& renderComponent)
{
