...
void App::run()
{
    while (!glfwWindowShouldClose(window))
    {
        ...
        (
            transformComponents, cameraID, *cameraComponent, 16.67 / 1000.0f
        );
        if (should_close)
        {
            break;
...
void App::set_up_opengl()
{
    ...
    // set the render region to the actual screen size
    int w, h;
    ...
    glm::mat4 projection = glm::perspective(45.0f, 640.0f / 480.f, 0.1f, 10.0f);
